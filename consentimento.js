(function () {
  ...
  function mount() {
    ...
    style.textContent =
      "#privacy-banner{position:fixed;z-index:9999;right:16px;bottom:16px;width:min(354px,calc(100vw - 32px));background:repeating-linear-gradient(118deg,transparent 0 22px,#efd27d0a 23px,transparent 24px 46px),linear-gradient(145deg,#14382f,#071f1a);color:#fffaf0;border:1px solid #d7b45e;border-radius:9px;padding:12px 13px;box-shadow:0 18px 42px #0008,inset 0 1px #fff2;font:11px/1.4 Manrope,Arial,sans-serif}#privacy-banner:before{content:'';position:absolute;inset:4px;pointer-events:none;border:1px solid #e4c97720;border-radius:5px}#privacy-banner p{position:relative;margin:0 0 8px;padding-right:2px}#privacy-banner strong{font-family:'Cormorant Garamond',Georgia,serif;font-size:16px;color:#fff}#privacy-banner a{color:#efd27d;text-decoration:underline}#privacy-banner .actions{position:relative;display:flex;gap:7px;justify-content:flex-end}#privacy-banner button{cursor:pointer;min-height:36px;border:1px solid #76988c;border-radius:4px;padding:6px 9px;color:#fffaf0;background:#ffffff08;font-size:10px;font-weight:750}#privacy-banner .accept{color:#092b23;background:linear-gradient(145deg,#fff0bd,#efd98c 48%,#c9a84e);border-color:#f3dda0;box-shadow:inset 0 1px #fff8,0 6px 14px #0004}@media(max-width:560px){#privacy-banner{left:8px;right:8px;bottom:8px;width:auto;padding:11px}#privacy-banner p{margin-bottom:7px;font-size:11px}#privacy-banner strong{font-size:14px}#privacy-banner .actions{gap:6px}#privacy-banner button{flex:1;min-height:42px;padding:6px;font-size:10px}}";
